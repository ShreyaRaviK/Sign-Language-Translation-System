...
CONFIDENCE_THRESHOLD = 0.3  # Reduced from 0.5 for better responsiveness
...
"""
    try:
        if not os.getenv("GEMINI_API_KEY"):
            LAST_GEMINI_ERROR = "GEMINI_API_KEY is not set in environment."
...
def index():
    ...
    if request.method == "POST":
        ...
        # Path for browser
        video_web_path = f"/uploads/{video.filename}"
